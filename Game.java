...
public class Game implements Serializable{
    ...
    public Game() {
        ...
        System.out.println("");
        System.out.println("In our game, Route 66, the player attempts to travel 2500 miles from Santa Monica to Chicago without starving, being arrested, or running out of time. At the beginning, the player picks the difficulty they want to play from three options: easy, medium, or hard. Then the player chooses a name and a car, each of which have distinct gameplay advantages. After this, the game begins. The player can choose from four actions: drive, earn money, shop, or get info on the actions, which doesn’t take any time from the game. If the player chooses to earn money, they are given 3 options: gamble, work, or rob a bank. If the player choses to shop, they can buy food or gas. During the game, the player will experience many events. They could randomly find money, win the lottery, be robbed of all their food and gas, be asked by a hitchhiker for food who generally take the food anyways, or get sick. Please enjoy and good luck!");
        System.out.println("");
